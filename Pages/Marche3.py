...
st.markdown("# Marche: 3 lot5")
st.sidebar.header(" Marche 3 lot5")
...
df = pd.read_excel('C:/Users/PC74/PycharmProjects/StreamLite_Project/inte.xlsx')
Marche2 = ['GUELMIM', 'AZILAL', 'BENI MELLAL', 'FKIH BEN SALAH', 'KHOURIBGA', 'SOUK SEBT', 'SIDI BENNOUR', 'EL HAOUZ', 'BEN GURIR', 'KALAA DES SRAGHNAS', 'ESSAOUIRA', 'MARRAKECH SYBA', 'MARRAKECH GUELIZ', 'INZEGANE', 'TAROUDANT']
